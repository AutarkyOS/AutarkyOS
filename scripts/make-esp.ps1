<#
.SYNOPSIS
    Create an EFI System Partition on the autark USB SSD.
...
param(
    [switch]$Execute,
    # The autark USB SSD, as surveyed. Override only if you know why.
...
Write-Host "create         : $ReservedSizeMB MB unformatted, reserved for the autark filesystem"
Write-Host ''
